...
bool CPU::Decode(CPUStat* myStat)
{
    ...
    // TODO: Compute the correct immediate once the instruction is decoded

    // cout << opcode.to_string() << endl;

    // Update CPUStats based on what instruction this is
    if (cur_instruction.getOpcode() != nop) {
        // Update Stats
        myStat->m_fetch_instr++;
    }
